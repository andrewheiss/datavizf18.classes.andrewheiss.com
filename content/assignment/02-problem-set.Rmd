...
[Download this R Markdown file](/files/your-name_problem-set-2.Rmd) and place it in your newly-created project^[{-} Again, you might have to right click on the link and choose "Save linke as…".] It contains an outline/skeleton of the two tasks you'll need to do in this problem set. Lots of the code is pre-written again!
